...
class ExpenseTravellingAdapter(
    val context: Context?,
    var expenseTypeList: ArrayList<ExpenseTypeResult>,
    val btnlistener: BtnClickListener
) : RecyclerView.Adapter<ExpenseTravellingAdapter.MyViewHolder>() {

    override fun onBindViewHolder(viewHolder: MyViewHolder, position: Int) {
        viewHolder.bindItems(position, context!!,expenseTypeList)
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(position: Int, context: Context,mtravelList : ArrayList<ExpenseTypeResult>) {
            ...
            tvExpenseType.setText(mtravelList!!.get(position).expName)
